...
def train(rank, gpu, args):
    ...
    algo = 'uot_xt_detach_r_both_pt3_bound'
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        for iteration, (x, y) in enumerate(tqdm(data_loader)):
            ...
            D_bound_error = phi_star1(-5 * (D_real + upper_d) - 5) + phi_star2(5 * (D_fake - upper_d) - 5)
            # D_bound_error = D_bound_error.mean()
            D_bound_error = (loss_weight * D_bound_error).mean()
            D_bound_error.backward()
