...
def train(rank, gpu, args):
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        for iteration, ((x, y), (x2, y2)) in enumerate(tqdm(zip(data_loader, data_loader_duplicate), total=total_iterations)):
            ...
            x_t_duplicate, x_tp1_duplicate, _ = q_sample_pairs(coeff, real_data_2, t)
            ...
            x_0_predict = netG(x_tp1_duplicate.detach(), t, latent_z).detach()
            x_pos_sample, _ = sample_posterior(pos_coeff, x_0_predict, x_tp1_duplicate, t)
            ...
            errD_regularization = phi_star1(D_fake - tau * torch.sum(((x_pos_sample-x_tp1_duplicate.detach()).view(x_tp1_duplicate.detach().size(0), -1))**2, dim=1)) + phi_star2(-D_real)
            ...
            x_0_predict = netG(x_tp1_duplicate.detach(), t, latent_z)
