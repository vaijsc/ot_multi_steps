...
def getCleanData(dataset, image_size=32):
    if dataset == 'cifar10':
        ...
        dataset = torchvision.datasets.ImageFolder(root='./data/horse2zebra/trainA', transform=train_transform)
        ...
        # Use torchvision's ImageFolder dataset to load your custom dataset
        dataset = torchvision.datasets.ImageFolder(root='./data/horse2zebra/trainB', transform=train_transform)
