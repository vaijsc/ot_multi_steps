...
def args_parser():
    ...
    parser.add_argument('--input_size', type=int, default=32,
                            help='size of input of networks')
    ...
    parser.add_argument('--exp', default='none', help='name of experiment')
    ...
    parser.add_argument('--lazy_potential', type=int, default=1,
                        help='the number of iterations for each potential update.')
    parser.add_argument('--loss_weight', type=float, default=1,
                        help='weight of D loss.')
    parser.add_argument('--step_weight', nargs='+', type=float,
                            help='channel multiplier')
    ...
    parser.add_argument('--save_content_epoch_every', type=int, default=300, help='save content of an epoch for resuming every x epochs')
    ...
    parser.add_argument('--tausp', type=float, default=0.001, help='proportion of the cost c for UOT')
    parser.add_argument('--bound', type=float, default=10, help='bound for discriminator')
    parser.add_argument('--decay_begin', type=int, default=200, help='start to decay')
    parser.add_argument('--decay_end', type=int, default=1200, help='stop decaying')

    parser.add_argument('--schedule', type=int, default=1800, help='cosine scheduler, learning rate 1e-5 until {schedule} epoch')
    parser.add_argument('--epoch', type=int, default=1, help='Specified epoch')
