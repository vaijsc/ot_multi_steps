...
def train(rank, gpu, args):
    ...
    algo = 'uot_xt_detach_r3_both_ptd_bound_2'
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        for iteration, (x, y) in enumerate(tqdm(data_loader)):
            ...
            errD_real = phi_star1(-loss_weight * (D_fake + upper_d) - loss_weight) + phi_star2(loss_weight * (D_real - upper_d) - loss_weight)
            ...
            x_t, x_tp1, x_tp1 = q_sample_pairs(coeff, real_data, t)
